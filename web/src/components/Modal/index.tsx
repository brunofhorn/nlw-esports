          ...
          item ? (
            <>
              ...
              <Dialog.Content
                forceMount
                asChild
                className='fixed bg-[#2A2634] py-8 px-10 text-white mt-1 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-[90%] md:w-[480px] shadow-lg shadow-black/25'
              >
